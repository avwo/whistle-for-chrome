...
function showIp(ip) {
	...
	var elem = $('<span id="' + id + '" style="position: fixed; z-index: 999999999; right: 10px; bottom: 3px; line-height: 14px; padding-left: 16px; overflow: hidden; height: 14px; display: inline-block; font-size: 12px!important; color: #555; font-family: Helvetica Neue,Helvetica,Arial,sans-serif;">'
